...
//
//-------------------------------------------------------------------------------------------------
int GenericIndicator::startCommunication(CANareoInterface & canObject)
{
	DPRINTINFO("START");
...
//
//-------------------------------------------------------------------------------------------------
uint8_t GenericIndicator::getCanAeroId()
{
	DPRINTINFO("START/STOP");
...
//
//-------------------------------------------------------------------------------------------------
IndicatorType GenericIndicator::type()
{
	DPRINTINFO("START/STOP");
