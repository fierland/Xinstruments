...
//
//---------------------------------------------------------------------------------------------------------------------
//class CANareoInterface;
// =================================================================
//canas service classes
// =================================================================
...
public:
	...
	*/
	CANAS_service(CANaeroBase *CanAsBus, uint8_t serviceID);
...
public:
	CANAS_service_identification(CANaeroBase* CanAsBus, CanasSrvIdsPayload* payload);
...
public:
	CANAS_service_timestamp(CANaeroBase* CanAsBus);
...
public:
	CANAS_service_requestdata(CANaeroBase* CanAsBus);
...
private:
	...
	int _findNode(_dataRequest* myStruct, uint8_t nodeId, bool doDelete = false);
